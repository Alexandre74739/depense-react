...
function Compteur() {
    ...
    const deleteSpend = (indexDelete) => {
        ...
        setTotal(prevTotal => prevTotal - parseFloat(itemDelete.number));   // On retire la somme de la dépense supprimée pour mettre à jour le total
        setSpend(spend.filter((_, index) => index !== indexDelete));    // Garde tous les éléments sauf celui cliqué
    }
