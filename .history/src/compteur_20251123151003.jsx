...
function Compteur() {
    ...
    const deleteSpend = (indexDelete) => {
        ...
        setSpend(spend.filter((_,index) => index !== indexDelete));
    }

    // Fonction pour supprimer une dépense
const deleteSpend = (indexToDelete) => {
    const itemToDelete = spend[indexToDelete];
    
    // Met à jour le total
    setTotal(prevTotal => prevTotal - parseFloat(itemToDelete.number));

    // Supprime la dépense du tableau
    setSpend(spend.filter((_, index) => index !== indexToDelete));
}
